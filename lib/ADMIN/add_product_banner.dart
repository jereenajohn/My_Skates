...
Widget bannerItem(Map<String, dynamic> item) {
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // IMAGE
            Positioned.fill(
              child: item['image'] != null && item['image'].toString().contains("http")
                  ? Image.network(
                      item['image'],
                      fit: BoxFit.cover,
                    )
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      item['title']?.toString().isNotEmpty == true ? item['title'] : "No Title",
  ...
  setState(() {
    ...
    existingBannerImage = item['image']; // show existing image
    pickedImage = null; // user will choose new image only if needed
  });
},
