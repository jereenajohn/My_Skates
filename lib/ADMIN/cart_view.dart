...
updatecart(int cartItemId, int quantity) async {
  ...
  try {
    ...
    debugPrint('Update Cart Response cartttttttttttttttttttt: ${response.body}');
 ...
 Future<void> fetchCart() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final cartData = decoded["data"]; // Map
      final List items = cartData["items"] ?? []; // ✅ List
...
Widget _buildOrderSummary() {
  ...
  final double payable =
      bagTotal - discount + platformFee; // delivery free
