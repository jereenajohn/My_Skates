...
class _CoachProfilePageState extends State<CoachProfilePage> {
  ...
  void initState() {
    ...
    // loadAllData().then((_) {
    //   print("After load - Username: ${usernameCtrl.text}");
    //   print("After load - Original username: $_originalUsername");
    //   print("After load - Is valid: $isUsernameValid");
  ...
  void mapExistingIDs() {
    ...
    // Fix for country - add orElse to prevent "No element" error
    ...
    if (selectedDistrict != null) {
      ...
      if (d.isNotEmpty) {
        selectedDistrict = d["id"].toString();
      } else {
    ...
    if (selectedState != null) {
      ...
      if (matchedState.isNotEmpty) {
        String stateName = matchedState["name"];
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 50), // Extra bottom space
                      ],
                    ),
                  ),
                ),
